...
- قم بإعادة ترتيب النص في فقرات صغيرة، بحيث لا تتجاوز كل فقرة 400 حرف.
...
2. تقسيم النص إلى فقرات صغيرة، مع مراعاة الحد الأقصى لعدد الأحرف.
...
- الفقرات يجب أن تكون قصيرة وواضحة، لا تتجاوز 400 حرف لكل فقرة.
